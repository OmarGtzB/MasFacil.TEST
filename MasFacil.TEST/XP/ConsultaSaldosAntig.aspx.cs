...
public partial class XP_ConsultaSaldosAntig : System.Web.UI.Page
{
    #region VARIABLES
    ...
    private void LlenaDatosSaldos()
    {
         ...
         Request.QueryString["provCve"] != null && Request.QueryString["provCve"] != "")
        {
            DataSet ds = new DataSet();
            MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
            ProcBD.NombreProcedimiento = "sp_ConsultaSaldosXPAntiguedad";
            ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
            ProcBD.AgregarParametrosProcedimiento("@provCve", DbType.String, 20, ParameterDirection.Input, Convert.ToInt32(Pag_ProvCve.Trim()));
