<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsultaSaldosMov.aspx.cs" Inherits="XP_ConsultaSaldosMov" %>
                    ...
                    <telerik:RadGrid ID="rGdvSaldos" 
                        ...
                        <MasterTableView     AutoGenerateColumns="False" CssClass="GridTable">
                         <Columns >
                                ...
                                <telerik:GridBoundColumn DataField="Referencia" HeaderText="Referencia"  HeaderStyle-Width="120px"  ItemStyle-Width="120px" Display="true" />
                                <telerik:GridBoundColumn DataField="CoA" HeaderText="Movimiento"  HeaderStyle-Width="80px"  ItemStyle-Width="80px" Display="true" />
