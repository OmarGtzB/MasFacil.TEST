<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdmonPagosRegistroMov.aspx.cs" Inherits="XP_AdmonPagosRegistroMov" %>
                            ...
                            <table border="0" style=" text-align:left; background-color:transparent; width:100%" >
                                <tr>
                                    <td>
                                        ...
                                        <asp:RadioButton ID="TipoProveedor" runat="server" GroupName="TipoAplicacion" Text="Proveedor"   Enabled="true" BackColor="Transparent" Width="100px" />
                                    </td>
                                    <td>
                                         <telerik:RadLabel ID="RadLabel8" runat="server" Text="Proveedor" Width="125px" BackColor="transparent"></telerik:RadLabel>
