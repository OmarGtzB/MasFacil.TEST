...
public partial class XP_AdmonPagosRegistroMov : System.Web.UI.Page
{
    ...
    protected void rCboMoneda_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
    {
        ...
        if (rCboMoneda.SelectedValue == ParametroMoneda())
        {
    ...
    private void InicioPagina()
    {
        ...
        FnCtlsFillIn.RabComboBox_Proveedores(Pag_sConexionLog, Pag_sCompania, ref rCboCuenta, true, false);
    ...
    private void ModificaDataSet()
    {
        ...
        if (TipoProveedor.Checked == true)
        {
            drMovDet[0]["movTipApliADes"] = "Proveedor";
    ...
    public string ParametroMoneda()
    {
        string Pag_MonedaParaLog = "";
