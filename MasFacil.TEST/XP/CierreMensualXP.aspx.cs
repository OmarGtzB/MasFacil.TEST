...
public partial class XP_CierreMensualXP : System.Web.UI.Page
{
    #region VARIABLES
    ...
    public void LlenaGrid()
    {
        ...
        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
        ProcBD.AgregarParametrosProcedimiento("@moduCve", DbType.String, 10, ParameterDirection.Input, "XP");
        ds = oWS.ObtenerDatasetDesdeProcedimiento(ProcBD.ObtenerXmlProcedimiento(), Pag_sConexionLog);
    ...
    private void EjecutaSpAcciones()
    {
        ...
        ProcBD.AgregarParametrosProcedimiento("@moduCve", DbType.String, 2, ParameterDirection.Input, "XP");
