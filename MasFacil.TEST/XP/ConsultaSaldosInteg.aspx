<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsultaSaldosInteg.aspx.cs" Inherits="XP_ConsultaSaldosInteg" %>
            ...
            <td>
              <fieldset style="">
                ...
                <div style="width:100%; display:table; margin-top:5px; position:static; background-color:transparent;" align="center">
                    ...
                    <telerik:RadGrid ID="rGdvIntegracionSaldosXP" 
                        runat="server"
                        ...
                        <MasterTableView     AutoGenerateColumns="False" CssClass="GridTable">
                         <Columns >
                                ...
                                <telerik:GridBoundColumn DataField="provCve" HeaderText="Concepto" HeaderStyle-Width="150px"  ItemStyle-Width="150px" Display="true" />
                                ...
                                <telerik:GridBoundColumn Aggregate="Sum" DataField="saldo" HeaderText="Importe." HeaderStyle-Width="110px"  ItemStyle-Width="110px" Display="true" FooterAggregateFormatString="Total: {0:###,##0.00}" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" />                    
