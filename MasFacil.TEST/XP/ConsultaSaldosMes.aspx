<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsultaSaldosMes.aspx.cs" Inherits="XP_ConsultaSaldoMes" %>
...
<head runat="server">
    ...
    <script>
        function openPopUpSaldosMov(pPerAnio, pPerNum, provCve) {
            window.open("ConsultaSaldosMov.aspx?pPerAnio=" + pPerAnio + "&pPerNum=" + pPerNum + "&provCve=" + provCve + "&pMovAcum=0", "WindowPopup1", "width=810px, height=480px, resizable");
        }
    </script>
                    ...
                    <telerik:RadGrid ID="rGdvSaldos" 
                        ...
                        <MasterTableView     AutoGenerateColumns="False" CssClass="GridTable">
                         <Columns >
                                ...
                                <telerik:GridBoundColumn DataField="salXPIni" HeaderText="Saldo Inicial" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" />
                                <telerik:GridBoundColumn DataField="salXPCgo" HeaderText="Cargos" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" />
                                <telerik:GridBoundColumn DataField="salXPAbo" HeaderText="Abonos" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" />
