<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoFormaPago.aspx.cs" Inherits="SAT_CatalogoFormaPago" %>
             ...
             <asp:Panel ID="Panel1" Width="100%" CssClass="cspnlBtnsAcciones"  runat="server">
                ...
                <div> 
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_CatFormaPago"  OnSelectedIndexChanged="rGdv_CatFormaPago_SelectedIndexChanged"
                            runat="server" 
                            AutoGenerateColumns="False"
                            Width="463px"   Height="280px"  
                            CssClass="Grid" 
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satFormaPagCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satFormaPagCve" HeaderStyle-Width="55px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satFormaPagDes" HeaderStyle-Width="200px" ></telerik:GridBoundColumn>
                                     </Columns>
