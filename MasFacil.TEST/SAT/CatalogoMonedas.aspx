<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoMonedas.aspx.cs" Inherits="SAT_CatalogoMonedas" %>
                ...
                <div> 
                    ...
                    <legend>Datos</legend>
                        <table>
                            ...
                            <tr>
                                <td><asp:Label ID="Label3" runat="server" Text="Decimales"></asp:Label></td>
                                <td><telerik:RadNumericTextBox ID="rTxtDecimales" runat="server" MaxLength="1"
                                EnabledStyle-CssClass="cssTxtEnabled"  Enabled="false" Width="40px"
                                DisabledStyle-CssClass ="cssTxtEnabled"
                                HoveredStyle-CssClass="cssTxtHovered"
                                FocusedStyle-CssClass="cssTxtFocused"
                                InvalidStyle-CssClass="cssTxtInvalid"><NumberFormat DecimalDigits="0" /></telerik:RadNumericTextBox></td>
                                <td><asp:Label ID="Label4" runat="server" Text="% Variación"></asp:Label></td>
                                <td><telerik:RadNumericTextBox ID="rTxtVariacion" runat="server"  MaxLength="2"
                                EnabledStyle-CssClass="cssTxtEnabled"  Enabled="false" Width="40px"
                                DisabledStyle-CssClass ="cssTxtEnabled"
                                HoveredStyle-CssClass="cssTxtHovered"
                                FocusedStyle-CssClass="cssTxtFocused"
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_CatMoneda"   OnSelectedIndexChanged="rGdv_CatMoneda_SelectedIndexChanged"
                            runat="server" 
                            AutoGenerateColumns="False"
                            Width="515px"   Height="280px"  
                            CssClass="Grid" 
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satMonCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satMonCve" HeaderStyle-Width="50px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satMonDes" HeaderStyle-Width="200px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Decimales" DataField="satMonDec" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Right"  ></telerik:GridBoundColumn>                             
                                        <telerik:GridBoundColumn HeaderText="% Variación" DataField="satMonPorcVari" HeaderStyle-Width="60px"  DataType="System.Decimal"   DataFormatString="{0:###,##0.}"  ItemStyle-HorizontalAlign="Right"  ></telerik:GridBoundColumn>
                                    </Columns>
