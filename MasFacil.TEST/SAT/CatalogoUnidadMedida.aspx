<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoUnidadMedida.aspx.cs" Inherits="SAT_CatalogoUnidadMedida" %>
             ...
             <asp:Panel ID="Panel1" Width="100%" CssClass="cspnlBtnsAcciones"  runat="server">
                ...
                <div> 
                    ...
                    <legend>Datos</legend>
                        <table>
                            <tr>
                                ...
                                <td><telerik:RadTextBox ID="rTxtNombre"  runat="server"  Enabled="false" MaxLength="100" Width="265px"
                                EnabledStyle-CssClass="cssTxtEnabled"
                                DisabledStyle-CssClass ="cssTxtEnabled"
                                HoveredStyle-CssClass="cssTxtHovered"
                                FocusedStyle-CssClass="cssTxtFocused"
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_SatUniMed" OnSelectedIndexChanged="rGdv_SatUniMed_SelectedIndexChanged"
                            runat="server" 
                            AutoGenerateColumns="False"
                            Width="463px"   Height="280px"  
                            CssClass="Grid" 
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satUniMedCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satUniMedCve" HeaderStyle-Width="55px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satUniMedNom" HeaderStyle-Width="200px" ></telerik:GridBoundColumn>
                                     </Columns>
