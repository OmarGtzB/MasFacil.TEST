<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoBancos.aspx.cs" Inherits="SAT_CatalogoBancos" %>
             ...
             <asp:Panel ID="Panel1" Width="100%" CssClass="cspnlBtnsAcciones"  runat="server">
                ...
                <div> 
                    ...
                    <legend>Datos</legend>
                        <table>
                            <tr>
                                ...
                                <td><telerik:RadTextBox ID="rTxtCve"  runat="server" Enabled="false" MaxLength="3" Width="80px"
                                ...
                                <td><telerik:RadTextBox ID="rTxtDes"  runat="server"  Enabled="false" MaxLength="50"  Width="210px"
                                EnabledStyle-CssClass="cssTxtEnabled"
                                DisabledStyle-CssClass ="cssTxtEnabled"
                                HoveredStyle-CssClass="cssTxtHovered"
                                FocusedStyle-CssClass="cssTxtFocused"
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="rTxtAbrev"  runat="server" Enabled="false" MaxLength="50"  Width="210px"
                                    EnabledStyle-CssClass="cssTxtEnabled"
                                    DisabledStyle-CssClass ="cssTxtEnabled"
                                    HoveredStyle-CssClass="cssTxtHovered"
                                    FocusedStyle-CssClass="cssTxtFocused"
                                ...
                                <td>
                                    <telerik:RadTextBox ID="rTxtRSocial"  runat="server" Enabled="false" MaxLength="50"  Width="210px"
                                    EnabledStyle-CssClass="cssTxtEnabled"
                                    DisabledStyle-CssClass ="cssTxtEnabled"
                                    HoveredStyle-CssClass="cssTxtHovered"
                                    FocusedStyle-CssClass="cssTxtFocused"
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_CatBanco"   OnSelectedIndexChanged="rGdv_CatMoneda_SelectedIndexChanged"
                            runat="server" 
                            AutoGenerateColumns="False"
                            Width="615px"   Height="270px"  
                            CssClass="Grid" 
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satBanCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satBanCve" HeaderStyle-Width="40px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satBanDes" HeaderStyle-Width="140px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Abreviatura" DataField="satBanNomCorto" HeaderStyle-Width="140px"  ></telerik:GridBoundColumn>                             
                                        <telerik:GridBoundColumn HeaderText="Razón Social" DataField="satBanRazSoc"   HeaderStyle-Width="140px"  ></telerik:GridBoundColumn>
                                    </Columns>
