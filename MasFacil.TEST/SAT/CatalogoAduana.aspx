<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoAduana.aspx.cs" Inherits="SAT_CatalogoAduana" %>
             ...
             <asp:Panel ID="Panel1" Width="100%" CssClass="cspnlBtnsAcciones"  runat="server">
                ...
                <div> 
                    ...
                    <legend>Datos</legend>
                        <table>
                            <tr>
                                ...
                                <td><telerik:RadTextBox ID="rTxtCve"  runat="server" Enabled="false" MaxLength="2" Width="45px"
                                ...
                                <td><telerik:RadTextBox ID="rTxtDes"  runat="server"  Enabled="false" MaxLength="60" Width="265px"
                                EnabledStyle-CssClass="cssTxtEnabled"
                                DisabledStyle-CssClass ="cssTxtEnabled"
                                HoveredStyle-CssClass="cssTxtHovered"
                                FocusedStyle-CssClass="cssTxtFocused"
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_Aduana" OnSelectedIndexChanged="rGdv_Aduana_SelectedIndexChanged"
                            runat="server" 
                            AutoGenerateColumns="False"
                            Width="463px"   Height="280px"  
                            CssClass="Grid" 
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satAduCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satAduCve" HeaderStyle-Width="50px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satAduDes" HeaderStyle-Width="200px" ></telerik:GridBoundColumn>
                                     </Columns>
