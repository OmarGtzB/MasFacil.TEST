<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoTipoDeComprobante.aspx.cs" Inherits="SAT_CatalogoTipoDeComprobante" %>
       ...
       <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div>
            ...
            <div style="width:100%; display:table; position:static; background-color:transparent;" align="center" >   
                ...
                <table border="0" style=" width:400px; text-align:left; background-color:transparent;">
                    <tr style="height:18px;">
                        ...
                        <td style=" width:180px;  background-color:transparent;">                             
                            <telerik:RadTextBox ID="rTxtDes" runat="server" Width="170px"
                                            EnabledStyle-CssClass="cssTxtEnabled"
                                            DisabledStyle-CssClass ="cssTxtEnabled"
                                            HoveredStyle-CssClass="cssTxtHovered"
                                            FocusedStyle-CssClass="cssTxtFocused"
            ...
            <div style="width:100%; display:table; margin-top:5px; position:static; background-color:transparent;" align="center">
                ...
                <telerik:RadGrid ID="rGdvSat"   OnSelectedIndexChanged="rGdvSat_SelectedIndexChanged"
                    ...
                    <MasterTableView  DataKeyNames="satTipoCompCve"  AutoGenerateColumns="False"   CssClass="GridTable" >
                        <Columns>
                            <telerik:GridBoundColumn DataField="satTipoCompCve" HeaderText="Clave"       HeaderStyle-Width="50px"  ItemStyle-Width="50px"  />
                            <telerik:GridBoundColumn DataField="satTipoCompDes" HeaderText="Descripción" HeaderStyle-Width="350px"  ItemStyle-Width="350px"  />
                        </Columns>
