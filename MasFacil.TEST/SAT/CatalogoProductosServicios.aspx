<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoProductosServicios.aspx.cs" Inherits="SAT_CatalogoProductosServicios" %>
             ...
             <asp:Panel ID="Panel1" Width="100%" CssClass="cspnlBtnsAcciones"  runat="server">
                ...
                <div> 
                    ...
                    <legend>Datos</legend>
                        <table>
                            <tr>
                                ...
                                <td><telerik:RadTextBox ID="rTxtCve"  runat="server" Enabled="false" MaxLength="8" Width="90px"
                                ...
                                <td><telerik:RadTextBox ID="rTxtDes"  runat="server"  Enabled="false" MaxLength="100" Width="310px"
                                EnabledStyle-CssClass="cssTxtEnabled"
                                DisabledStyle-CssClass ="cssTxtEnabled"
                                HoveredStyle-CssClass="cssTxtHovered"
                                FocusedStyle-CssClass="cssTxtFocused"
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_SatProducServicio" OnSelectedIndexChanged="rGdv_SatProducServicio_SelectedIndexChanged"
                            runat="server" 
                            AutoGenerateColumns="False"
                            Width="560px"   Height="280px"  
                            CssClass="Grid" 
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satProdServCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satProdServCve" HeaderStyle-Width="55px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satProdServDes" HeaderStyle-Width="200px" ></telerik:GridBoundColumn>
                                     </Columns>
