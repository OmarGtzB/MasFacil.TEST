<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogoPaises.aspx.cs" Inherits="SAT_CatalogoPaises" %>
                    ...
                    <legend>Datos</legend>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="rTxtDes"  runat="server" Enabled="false" MaxLength="50"  Width="375px"
                                    EnabledStyle-CssClass="cssTxtEnabled"
                                    DisabledStyle-CssClass ="cssTxtEnabled"
                                    HoveredStyle-CssClass="cssTxtHovered"
                                    FocusedStyle-CssClass="cssTxtFocused"
                 ...
                 <div style="width:100%; margin-top:5px; display:table; position:static; background-color:transparent;" align="center" > 
                    <telerik:RadGrid ID="rGdv_CatBanco"   OnSelectedIndexChanged="rGdv_CatMoneda_SelectedIndexChanged"
                            ...
                            Skin="Office2010Silver">
                                <MasterTableView DataKeyNames="satPaisCve" AutoGenerateColumns="false" CssClass="GridTable">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Clave" DataField="satPaisCve" HeaderStyle-Width="40px" ></telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn HeaderText="Descripción" DataField="satPaisDes" HeaderStyle-Width="140px" ></telerik:GridBoundColumn>
                                    </Columns>
