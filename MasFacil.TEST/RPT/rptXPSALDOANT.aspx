<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptXPSALDOANT.aspx.cs" Inherits="RPT_rptXPSALDOANT" %>
                                                    ...
                                                    <tr style=" height:35px;">     
                                                        <td style=" width:380px; background-color:transparent; vertical-align:top;" >
                                                               ...
                                                               <table border="0" cellpadding="0" cellspacing="0" style=" width:380px;   border-style:none; text-align:left; background-color:transparent;">
                                                                    ...
                                                                    <tr style=" height:35px;">     
                                                                        <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                                            <asp:Label ID="Label4" runat="server" Text="Mostrar Saldo:"></asp:Label> 
                                                                        </td>       
                                                                        <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                              <asp:RadioButton ID="rBtnCheckVencido" runat="server" GroupName="Saldo"  Text="Vencido" OnCheckedChanged="rBtnRegTransaccion_CheckedChanged" Checked="true" AutoPostBack="true"  />
                                                                               <asp:RadioButton ID="rBtnCheckPorVencer"  runat="server"   GroupName="Saldo" Text="Por Vencer"  OnCheckedChanged="rBtnRegTransaccion_CheckedChanged" Checked="false"   AutoPostBack="true" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr style=" height:35px;">     
                                                                        <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                                        ...
                                                                        <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                              <asp:RadioButton ID="rBtnCheckOrdenClienteNum" runat="server" GroupName="ClienteOrden"   Text="Proveedor" OnCheckedChanged="rBtnRegTransaccion_CheckedChanged" Checked="true"    />
                                                                               <asp:RadioButton ID="rBtnCheckOrdenClienteNom"  runat="server"   GroupName="ClienteOrden" Text="Nombre Proveedor"  OnCheckedChanged="rBtnRegTransaccion_CheckedChanged" Checked="false"    />
                                                                        </td>
                                                                    </tr>
                                                                </table>  
