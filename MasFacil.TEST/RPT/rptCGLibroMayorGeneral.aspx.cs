...
public partial class RPT_rptCGLibroMayorGeneral : System.Web.UI.Page
{
    ...
    {      
            ...
            MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
            ProcBD.NombreProcedimiento = "sp_rptCGLIBROMAYOR";           
            ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
            ...
            ProcBD.AgregarParametrosProcedimiento("@folIni", DbType.Int64, 0, ParameterDirection.Input, txtFilioIni.Text.Trim());
