...
public partial class RPT_rptINARTLIST : System.Web.UI.Page
{
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        ProcBD.AgregarParametrosProcedimiento("@orden", DbType.Int64, 0, ParameterDirection.Input, Ordenamiento1());
    ...
    private int Ordenamiento1()
    {
        if (rBtnCheckOrdenArtClave.Checked == true)
        {
            return 1;
        }
        else if (rBtnCheckOrdenArtDescripcion.Checked == true)
        {
            return 2;
        }
        return 0;
