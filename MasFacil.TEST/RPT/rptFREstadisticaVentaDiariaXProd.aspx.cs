...
public partial class RPT_rptFREstadisticaVentaDiariaXProd : System.Web.UI.Page
{
    #region VARIABLES
    ...
    {
        hdfRptCve.Value = "FREstVenDiaXProd";
    ...
    private void InicioLlenaControles()
    {
        ...
        FnCtlsFillIn.RabComboBox_Clientes(Pag_sConexionLog, Pag_sCompania, ref rCboClientes, true, false);


        rFecCalculo.SelectedDate = DateTime.Now;
  ...
  ((Literal)objRadComboBox.Footer.FindControl("RadComboItemsCount")).Text = "Total de registros " + "0";
    ...
    private void ShowCheckedItemsArt()
    {
        ...
        if (collection.Count != 0)
        {
            ...
            foreach (var item in collection)
            {
                ...
                ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
                ProcBD.AgregarParametrosProcedimiento("@maUsuCve", DbType.String, 20, ParameterDirection.Input, maUser);
                ProcBD.AgregarParametrosProcedimiento("@FilCve", DbType.String, 20, ParameterDirection.Input, hdfRptCve.Value.ToString() + "-art");
    ...
    private void ShowCheckedItemsClientes()
    {
        string maUser = LM.sValSess(this.Page, 1);
        var collection = rCboClientes.CheckedItems;
        ...
        if (collection.Count != 0)
        {
            ...
            foreach (var item in collection)
            {
                ...
                ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
                ProcBD.AgregarParametrosProcedimiento("@maUsuCve", DbType.String, 20, ParameterDirection.Input, maUser);
                ProcBD.AgregarParametrosProcedimiento("@rptCve", DbType.String, 20, ParameterDirection.Input, hdfRptCve.Value.ToString() + "-cli");
    ...
    private string sObtenerFechaCalculo()
    {
        ...
        string Fec = rFecCalculo.SelectedDate.ToString();
        if (Fec != "")
        {
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        string maUser = LM.sValSess(this.Page, 1);
        string stored = "sp_rptFREstadisticoDiarioArt";
        ...
        //
        if (chkDetalleOculto.Checked == true)
        {
            ProcBD.AgregarParametrosProcedimiento("@ocultaDet", DbType.Int64, 0, ParameterDirection.Input, 1);
        }
        else
        {
            ProcBD.AgregarParametrosProcedimiento("@ocultaDet", DbType.Int64, 0, ParameterDirection.Input, 2);
        }
        //
