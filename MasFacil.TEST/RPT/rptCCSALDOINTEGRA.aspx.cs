...
public partial class RPT_rptCCSALDOINTEGRA : System.Web.UI.Page
{
    #region VARIABLES
    ...
    protected void rbtnCrearReporte_Click(object sender, EventArgs e)
    {
        ...
        if (FnValAdoNet.bDSRowsIsFill(dsInputGral))
        {
            ...
            //x = oWSRpt.byte_Report(dsInputAux,dsInputGral);
    ...
    {
        hdfRptCve.Value = "CCSALDOINTEGRA";
    ...
    private void ShowCheckedItems(RadComboBox comboBox)
    {
        ...
        if (collection.Count != 0)
        {
            ...
            foreach (var item in collection)
            {
                ...
                ProcBD.AgregarParametrosProcedimiento("@rptCve", DbType.String, 20, ParameterDirection.Input, "CCSALDOINTEGRA");
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
        ProcBD.NombreProcedimiento = "sp_rptCCSALDOINTEGRA";
