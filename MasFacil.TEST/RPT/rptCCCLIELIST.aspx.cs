...
public partial class RPT_rptCCCLIELIST : System.Web.UI.Page
{
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        ProcBD.AgregarParametrosProcedimiento("@orden", DbType.Int64, 0, ParameterDirection.Input, OrdenamientoClie_Nom());
        ProcBD.AgregarParametrosProcedimiento("@ordenAscDesc", DbType.Int64, 0, ParameterDirection.Input, OrdenamientoAscenDesc());
    ...
    private int OrdenamientoClie_Nom()
    {
        ...
        if (rBtnCheckOrdenClienteNum.Checked == true)
        {
            return 1;
        }
        else if (rBtnCheckOrdenClienteNom.Checked == true)
        {
            return 2;
        }
        return 0;
