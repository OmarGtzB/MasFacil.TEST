...
public partial class RPT_rptCGRelacionSaldos : System.Web.UI.Page
{
    #region VARIABLES
    ...
    {
        hdfRptCve.Value = "CGRELACIONSALDOS";
    ...
    private void InicioLlenaControles()
    {
        ...
        LlenaComboEstrucCodCta();
    }

    private void LlenaComboEstrucCodCta()
    {
        DataSet ds = new DataSet();
        MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
        ProcBD.NombreProcedimiento = "sp_CuentaContableEstructuraCodigo";
        ProcBD.AgregarParametrosProcedimiento("@opc", DbType.Int64, 0, ParameterDirection.Input, 50);
        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
        ds = oWS.ObtenerDatasetDesdeProcedimiento(ProcBD.ObtenerXmlProcedimiento(), Pag_sConexionLog);

        FnCtlsFillIn.RadComboBox(ref rCboNivelEstCodCta, ds, "ctaContEstCodNiv", "ctaContEstCodDes", true, false);
        ((Literal)rCboNivelEstCodCta.Footer.FindControl("RadComboItemsCount")).Text = "Total de registros " + Convert.ToString(rCboNivelEstCodCta.Items.Count);
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
        ProcBD.NombreProcedimiento = "sp_rptCGBALANZACOMPARA_1";
        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
        ...
        //ProcBD.AgregarParametrosProcedimiento("@perNumFin", DbType.Int64, 0, ParameterDirection.Input, rCboNumPeriodoFinal.SelectedValue);
        if (rCboNivelEstCodCta.SelectedIndex != -1)
        {
            ProcBD.AgregarParametrosProcedimiento("@ctaContEstCodNiv", DbType.Int64, 0, ParameterDirection.Input, rCboNivelEstCodCta.SelectedValue);
        }
        ProcBD.AgregarParametrosProcedimiento("@filtro", DbType.String, 10, ParameterDirection.Input, rTxtFiltro.Text.Trim());
