<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptINRELEXIS.aspx.cs" Inherits="RPT_rptINRELEXIS" %>
                                                    ...
                                                    <td style=" width:380px; background-color:transparent; vertical-align:top;" >
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style=" width:380px;   border-style:none; text-align:left; background-color:transparent;">
                                                                ...
                                                                <tr style=" height:35px;">     
                                                                    ...
                                                                    <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                    <asp:RadioButton ID="rBtnCheckExistencias" runat="server" GroupName="Relacion"  Text="Relacion de Existencias"  Checked="true" AutoPostBack="true"  />
                                                                    </td>
                                                                </tr>
                                                                <tr style=" height:35px;">     
                                                                    <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                                    ...
                                                                    <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                        <asp:RadioButton ID="rBtnCheckExistenciasValu"  runat="server"   GroupName="Relacion" Text="Relacion de Existencias Valuadas" Checked="false"   AutoPostBack="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr style=" height:35px;">     
                                                                    <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                            ...
                                                            <table runat="server" visible="true" border="0" cellpadding="0" cellspacing="0" style=" width:380px;   border-style:none; text-align:left; background-color:transparent;">
                                                                <tr style=" height:35px;" >     
                                                                    ...
                                                                    <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                        ...
                                                                        <asp:RadioButton ID="rBtnCheckOrdenDesArt"  runat="server"   GroupName="Ordenamiento" Text="Descripcion Art."  Checked="false"   />
