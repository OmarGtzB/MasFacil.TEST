...
public partial class RPT_rptCCEstadosCta : System.Web.UI.Page
{
    #region VARIABLES
    ...
    {
        FnCtlsFillIn.RabComboBox_PeriodoNum(Pag_sConexionLog, Pag_sCompania, Convert.ToInt16(rCboAnioPeriodo.SelectedValue), ref rCboNumPeriodoInicio, true, false);
    ...
    protected void rBtnFormato_CheckedChanged(object sender, EventArgs e)
    {
    ...
    private void InicioPagina()
    {
        ...
        {
            //combo de subcliente
            lblSubClientes.Visible = true;
            rCboSubClientes.Visible = true;
        }
        else
        {
            //combo de subcliente
            lblSubClientes.Visible = false;
    ...
    private void InicioLlenaControles()
    {
        ...
        {
            FnCtlsFillIn.RabComboBox_PeriodoNum(Pag_sConexionLog, Pag_sCompania, Convert.ToInt16(rCboAnioPeriodo.SelectedValue), ref rCboNumPeriodoInicio, true, true);
        ...
        FnCtlsFillIn.RabComboBox_ClientesVW(Pag_sConexionLog, Pag_sCompania, ref rCboClientes, true, false);
    }

    private void ManejoSubCliente()
    {
        rBtnCheckNivelDetCliente.Checked = true;
        if (FNGrales.bManejoSubCliente(Pag_sConexionLog, Pag_sCompania) == false)
        {
            rBtnCheckNivelDetSubCliente.Enabled = false;
        }
    ...
    private void ShowCheckedItems(RadComboBox comboBox)
    {
        ...
        if (collection.Count != 0)
        {
            ...
            foreach (var item in collection)
            {
                ...
                MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
                ProcBD.NombreProcedimiento = "sp_rptFiltroClientes_Paso";
                ProcBD.AgregarParametrosProcedimiento("@opc", DbType.Int64, 0, ParameterDirection.Input, 1);
                ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
                ProcBD.AgregarParametrosProcedimiento("@maUsuCve", DbType.String, 20, ParameterDirection.Input, maUser);
    ...
    public void Limpia_FiltroClientes_Paso()
    {
        string maUser = LM.sValSess(this.Page, 1);
        DataSet ds = new DataSet();
        MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
    ...
    private int iObtenerNivelDet()
    {
        int iResult = 1;

        if (rBtnCheckNivelDetCliente.Checked == true)
        {
            iResult = 1;
        }
        if (rBtnCheckNivelDetSubCliente.Checked == true)
        {
            iResult = 2;
        }
        //if (rBtnCheckNivelDetAmbos.Checked == true)
        //{
        //    iResult = 3;
        //}
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
        ProcBD.NombreProcedimiento = "sp_rptCCSALDOANT";
        ...
        //ProcBD.AgregarParametrosProcedimiento("@nivel", DbType.Int64, 0, ParameterDirection.Input, iObtenerNivelDet());
        ...
        {
            ProcBD.AgregarParametrosProcedimiento("@monCons", DbType.Int64, 0, ParameterDirection.Input, 1);
        }
        else
        {
            ProcBD.AgregarParametrosProcedimiento("@monCons", DbType.Int64, 0, ParameterDirection.Input, 2);
        }
        //
