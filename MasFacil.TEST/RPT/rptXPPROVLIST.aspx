<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptXPPROVLIST.aspx.cs" Inherits="RPT_rptXPPROVLIST" %>
                                        ...
                                        <div style="width:100%; height:250px; display:table; position:static; background-color:transparent;" align="center" > 
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" style=" width:630px;   border-style:none; text-align:left; background-color:transparent;">
                                                    <tr style=" height:35px; background-color:transparent;">     
                                                                        ...
                                                                        <telerik:RadComboBox ID="rCboFormato" runat="server" Width="200px" 
                                                                            ...
                                                                            Height="100px"
                                                                             OnSelectedIndexChanged="rCboFormato_SelectedIndexChanged"
                                                                               >
                                                                                <Items>
                                                                                    <telerik:RadComboBoxItem Value ="XPPROVLIST" Text="Lista" />
                                                                                    <telerik:RadComboBoxItem Value ="XPPROVDIR"  Text="Directorio" />
                                                                                    <telerik:RadComboBoxItem Value ="XPPROVEXP"  Text="Expediente" />
                                                                                </Items>
                                                                        </telerik:RadComboBox>
                                                                    </td>
                                                                </tr>
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0" style=" width:380px;   border-style:none; text-align:left; background-color:transparent;">                                                       
                                                                <tr style=" height:35px;  background-color:transparent; ">     
                                                                    ...
                                                                    <td style=" width:190px;  background-color:transparent;" >
                                                                            <asp:RadioButton ID="rBtnCheckOrdenProveedorNum" runat="server" GroupName="ProveedorOrden"   Text="Proveedor"   Checked="true"   />
                                                                    </td>
                                                                    <td style="  width:300px; background-color:transparent;" >
                                                                            <asp:RadioButton ID="rBtnCheckOrdenProveedorNom"  runat="server"   GroupName="ProveedorOrden" Text="Nombre"   Checked="false" />
                                                                    </td>
                                                                </tr>
                                                                <tr style=" height:35px; background-color:transparent;">   
                                                                    <td style=" width:20px; background-color:transparent; vertical-align:top;">
                                                                    </td>                           
                                                                    <td style=" width:190px; background-color:transparent; vertical-align:top;">
                                                        ...
                                                        <td style=" width:250px; height:210px; background-color:gainsboro; vertical-align:top;">
                                                    ...
                                                    <tr style=" height:35px;">     
                                                        <td style=" width:380px; background-color:transparent; vertical-align:top;" >
                                                               ...
                                                               <table border="0" cellpadding="0" cellspacing="0" style="    border-style:none; text-align:left; background-color:transparent;">
                                                                    <tr style=" height:35px;">     
                                                                        <td style=" width:57px; background-color:transparent; vertical-align:initial;">
                                                                            <asp:Label ID="Label38" runat="server" Text="Prov."></asp:Label> 
                                                                        </td>       
                                                                        ...
                                                                        <td style=" width:195px; background-color:transparent; vertical-align:top;">
                                                                               <telerik:RadComboBox ID="rCboProveedores" runat="server"  
                                                                                   ...
                                                                                   >
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <ul>
                                                                                                <li class="col1" style="width:100px;   vertical-align:middle; " ><%# DataBinder.Eval(Container.DataItem, "provCve")%></li>
                                                                                               <li class="col2" style="width:290px;   vertical-align:middle; " ><%# DataBinder.Eval(Container.DataItem, "provNom")%></li>
                                                                                            </ul>
                                                                                        </ItemTemplate>
...
                                            <telerik:RadButton RenderMode="Lightweight" ID="NewRegistrationButton" runat="server" OnClick="rbtnEjecutaReporte_Click" Text="Crear Reporte"></telerik:RadButton>
