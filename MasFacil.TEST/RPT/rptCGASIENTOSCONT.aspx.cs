...
public partial class RPT_rptCGASIENTOSCONT : System.Web.UI.Page
{
    #region VARIABLES
    ...
    {
        hdfRptCve.Value = "CGASIENTOSCONT";
    ...
    private DataSet dsReportsInputGral()
    {
        ...
        MGM.ProcedimientoAlmacenado.Procedimiento ProcBD = new MGM.ProcedimientoAlmacenado.Procedimiento();
        ProcBD.NombreProcedimiento = "sp_rptCGASIENTOSCONT";
        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
        ProcBD.AgregarParametrosProcedimiento("@perAnio", DbType.Int64, 0, ParameterDirection.Input, rCboAnioPeriodo.SelectedValue);
        ProcBD.AgregarParametrosProcedimiento("@perNumIni", DbType.Int64, 0, ParameterDirection.Input, rCboNumPeriodoInicial.SelectedValue);
