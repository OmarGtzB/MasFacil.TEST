<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptINARTPORFECHA.aspx.cs" Inherits="RPT_rptINARTPORFECHA" %>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" style=" width:380px;   border-style:none; text-align:left; background-color:transparent;">
                                                                ...
                                                                <tr style=" height:35px;">  
                                                                    ...
                                                                    <td style=" width:120px;   background-color:transparent; vertical-align:top;">
                                                                        <asp:Label ID="rptlNARTPORFECHAAño" runat="server"  Text="Año:"></asp:Label> 
                                                                    </td>       
                                                                ...
                                                                <tr style=" height:35px;">     
                                                                    <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                                        <asp:Label ID="Label" runat="server" Text="Fecha"></asp:Label> 
                                                                          </td>       
                                                                    <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                        <telerik:RadDatePicker ID="rDateFecCalculo" runat="server" Width="105px"  ></telerik:RadDatePicker>
                                                                    </td>
                                                                </tr>
                                                                       
                                                                <tr style=" height:35px;">     
                                                                    <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                                        <asp:Label ID="Label37" runat="server" Text="Referencia:"></asp:Label> 
                                                                    </td> 
                                                                    
                                                                        <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                            <telerik:RadComboBox ID="rCboFechaReferencia" runat="server" Width="190px" 
                                                                            AutoPostBack="true"
                                                                          HighlightTemplatedItems="true"
                                                                            DropDownCssClass="cssRadComboBox" 
                                                                            DropDownWidth="210px" 
                                                                            Height="190px">
                                                                                ...
                                                                                <Items>
                                                                                    <telerik:RadComboBoxItem Value ="Fec_Mov" Text="Fecha Movimiento" />
                                                                                    <telerik:RadComboBoxItem Value ="Fec_02" Text="Fecha 2" />
                                                                                </Items>
                                                                ...
                                                                <tr style=" height:35px;">  
                                                                    <td style=" width:120px; background-color:transparent; vertical-align:top;">
                                                                        <asp:Label ID="Label36" runat="server" Text="Registros"></asp:Label> 
                                                                    </td>
                                                                    <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                        <asp:RadioButton ID="rptlNARTPORFECHAVencidos" runat="server" GroupName="RegistrosrptiNARTPORFECHA"  Text="Vencidos"  Checked="false"  />
                                                                        <asp:RadioButton ID="rptlNARTPORFECHAPorvencer" runat="server" GroupName="RegistrosrptiNARTPORFECHA" Text="Por Vencer" Checked="false"   />
                                                                ...
                                                                <tr style=" ">  
                                                                    ...
                                                                    <td style=" width:260px; background-color:transparent; vertical-align:top;">
                                                                        <asp:RadioButton ID="rptlNARTPORFECHAAmbos" runat="server" GroupName="RegistrosrptiNARTPORFECHA" Text="Ambos" Checked="true"   />
                                                                    </td>
                                                                </tr>    
