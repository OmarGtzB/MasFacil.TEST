<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptINARTLIST.aspx.cs" Inherits="RPT_rptINARTLIST" %>
                                                          ...
                                                          <table border="0" cellpadding="0" cellspacing="0" style=" width:380px;   border-style:none; text-align:left; background-color:transparent;">
                                                                <tr style=" height:35px;  background-color:transparent; ">     
                                                                    ...
                                                                    <td style=" width:240px;  background-color:transparent;" >
                                                                            <asp:RadioButton ID="rBtnCheckOrdenArtClave" runat="server" GroupName="rBtnCheckOrdenArt"   Text="Clave"   Checked="true"   />
                                                                    </td>
                                                                    <td style="  width:300px; background-color:transparent;" >
                                                                            <asp:RadioButton ID="rBtnCheckOrdenArtDescripcion"  runat="server"   GroupName="rBtnCheckOrdenArt" Text="Descripcion"   Checked="false" />
                                                                    </td>
                                                                </tr>
                                                                <tr style=" height:35px; background-color:transparent;">   
