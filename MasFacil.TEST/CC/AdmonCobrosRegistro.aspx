<%@ Page Title="" Language="C#" MasterPageFile="~/MPForm.master" AutoEventWireup="true" CodeFile="AdmonCobrosRegistro.aspx.cs" Inherits="CC_AdmonCobrosRegistro" %>
                            ...
                            <table border="0" style=" border-style:none;   text-align:left; background-color:transparent;">
                                ...
                                <tr>
                                    ...
                                    <td style=" width:100px; background-color:transparent; vertical-align:top;">
                                        <asp:Label ID="Label13" runat="server" Visible="false" Text="Cliente"></asp:Label>
                                    </td>
                                    ...
                                    <td style=" width:200px; background-color:transparent; vertical-align:top;">
                                        <telerik:RadTextBox ID="rTxtBeneficiario" Visible="false" 
                                            EnabledStyle-CssClass="cssTxtEnabled"
                                                                                        DisabledStyle-CssClass ="cssTxtEnabled"
                                                                                        HoveredStyle-CssClass="cssTxtHovered"
                                                                                        FocusedStyle-CssClass="cssTxtFocused"
                                        ...
                                        <telerik:RadComboBox ID="rCboBeneficiario" runat="server" Width="150px" AutoPostBack="true"
                                               Visible="false"
                                                    HighlightTemplatedItems="true"
                                                    DropDownCssClass="cssRadComboBox" 
                                                    DropDownWidth="300px" 
