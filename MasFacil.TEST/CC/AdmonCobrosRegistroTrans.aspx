<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdmonCobrosRegistroTrans.aspx.cs" Inherits="CC_AdmonCobrosRegistroTrans" %>
            ...
            <ContentTemplate>
                 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div runat="server" id="divForm" visible="true">   
                        ...
                        <fieldset style="">
                            <legend>Transaccion Detalle</legend>
                                <div style="overflow:auto; width:433px; height:300px; margin-left:1px; background-color:Transparent;" >
                    ...
                    <div id="divGrid" runat="server" visible="false">
                        ...
                        <fieldset style="">
                            <legend>Cobros Pendientes</legend>
                            ...
                            <telerik:RadGrid ID="rGdvPagosPend" 
                                 ...
                                 OnSelectedIndexChanged="rGdvPagosPend_SelectedIndexChanged"
                                                    ...
                                                    <MasterTableView   DataKeyNames="partPenCobId" AutoGenerateColumns="false"  CssClass="GridTable"  >
                                            ...
                                            <Columns >
                                                    ...
                                                    <telerik:GridBoundColumn DataField="partPenCobFecMov"  HeaderText="Fecha"              HeaderStyle-Width="50px"  ItemStyle-Width="50px"   Display="true" DataFormatString="{0:d}"/>
                                                    <telerik:GridBoundColumn DataField="partPenCobFecProg" HeaderText="Fecha Prog."        HeaderStyle-Width="50px"  ItemStyle-Width="50px"   Display="true" DataFormatString="{0:d}"/>
                                                    <telerik:GridBoundColumn DataField="partPenCobImpCgo"  HeaderText="Importe"            HeaderStyle-Width="50px"  ItemStyle-Width="50px"   Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right"/>
                                                    <telerik:GridBoundColumn DataField="partPenCobImpCgo"  HeaderText="Importe a Aplicar"  HeaderStyle-Width="50px"  ItemStyle-Width="50px"   Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right"/>
                                                    
                                                    <telerik:GridBoundColumn DataField="cliCve"    HeaderText="Cliente" HeaderStyle-Width="50px"  ItemStyle-Width="50px"   Display="true"/>
                                                    <telerik:GridBoundColumn DataField="partPenCobFecVenc" HeaderText="Fecha Venc." HeaderStyle-Width="50px"  ItemStyle-Width="50px"   Display="true" DataFormatString="{0:d}"/>
