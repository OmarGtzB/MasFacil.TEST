<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsultaSaldosMes.aspx.cs" Inherits="IN_ConsultaSaldosMes" %>
...
<head runat="server">
    ...
    <script>
        function openPopUpSaldosMov(pPerAnio, pPerNum, artCve, almCve, Consolidado, RefSelect) {
            window.open("ConsultaSaldosMov.aspx?pPerAnio=" + pPerAnio + "&pPerNum=" + pPerNum + "&artCve=" + artCve + "&almCve=" + almCve + "&Consolidado=" + Consolidado + "&RefSelect=" + RefSelect + "&pMovAcum=0", "WindowPopup1", "width=1200px, height=480px, resizable");
        }
    </script>
            ...
            <tr align="top" align="center" style="width:100%; ">
                <td>
                    <asp:Panel ID="pnlTitlePage" runat="server"  CssClass="PnlMPFormTituloApartado" >
                        <asp:Label ID="lblTitlePage" runat="server" Text="Consulta de Existencias"></asp:Label> 
                    </asp:Panel> 
                </td>
            </tr>
        </table>
                        ...
                        <telerik:RadGrid ID="rGdvSaldos" 
                            ...
                            <MasterTableView     AutoGenerateColumns="False" CssClass="GridTable">
                             <Columns >
                                    ...
                                    <telerik:GridBoundColumn DataField="perDes"  HeaderText="Periodo" HeaderStyle-Width="150px" ItemStyle-Width="100px" Display="true" /> 
                                    <telerik:GridBoundColumn DataField="exiCanIni" HeaderText="Saldo Inicial" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />   
                                    <telerik:GridBoundColumn DataField="exiEntrada" HeaderText="Cargos" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
                                    <telerik:GridBoundColumn DataField="exiSalida" HeaderText="Abonos" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
                                    <telerik:GridBoundColumn DataField="salAct" HeaderText="Saldo Final" HeaderStyle-Width="100px"  ItemStyle-Width="100px" Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />                    
                            </Columns>
