<%@ Page Title="" Language="C#" MasterPageFile="~/MPForm.master" AutoEventWireup="true" CodeFile="ConsultaSaldos.aspx.cs" Inherits="CG_ConsultaSaldos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headMPForm" Runat="Server">
    ...
    <script>
        function openPopUpSaldosMes(pPerAnio, pPerNum, ctaContCve) {
            window.open("ConsultaSaldosMes.aspx?pPerAnio=" + pPerAnio + "&pPerNum=" + pPerNum + "&ctaContCve=" + ctaContCve, "WindowPopup", "width=690px, height=480px, resizable");
        }
        function openPopUpSaldosMov(pPerAnio, pPerNum, ctaContCve) {
            window.open("ConsultaSaldosMov.aspx?pPerAnio=" + pPerAnio + "&pPerNum=" + pPerNum + "&ctaContCve=" + ctaContCve, "WindowPopup1", "width=780px, height=480px, resizable");
        }
    </script>
    <style type="text/css">
        .rcbHeader ul,
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style=" border-style:none;   text-align:left; background-color:transparent;">
                                <tr   >                              
                                    ...
                                    <td style=" width:265px; background-color:transparent; vertical-align:top;">
                                        <telerik:RadComboBox ID="rCboCuentas" runat="server"   
                                                            OnSelectedIndexChanged="rCboCuentas_SelectedIndexChanged"
                                                            ...
                                                            >
                                                                ...
                                                                <ItemTemplate>
                                                                    <ul>
                                                                        <li class="col1" style="width:100px;   vertical-align:middle; " ><%# DataBinder.Eval(Container.DataItem, "ctaContCveFotmat")%></li>
                                                                        <li class="col2" style="width:300px;   vertical-align:middle; " ><%# DataBinder.Eval(Container.DataItem, "Descripcion")%></li>
                                                                    </ul>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                                    <asp:Literal runat="server" ID="RadComboItemsCount" />
                            ...
                            <div style="width:100%; height:310px;  display:table; position:static; background-color:transparent;" align="center" > 
                                ...
                                <div>
                                      ...
                                      <telerik:RadGrid ID="rGdvSaldos" 
                                                    ...
                                                    CssClass="Grid"
                                                    skin="Office2010Silver" ShowFooter="true" >
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn HeaderText="salCGTipApli" DataField="salCGTipApli"     HeaderStyle-Width="208px"  ItemStyle-Width="100px"  Display="false"  />
                                                <telerik:GridBoundColumn HeaderText="Cuenta Contable" DataField="ctaContCve"     HeaderStyle-Width="100px"  ItemStyle-Width="100px"  Display="false" />
                                                <telerik:GridBoundColumn HeaderText="Cuenta Contable" DataField="ctaContCveFotmat"     HeaderStyle-Width="100px"  ItemStyle-Width="100px"  Display="true" />
                                                <telerik:GridBoundColumn HeaderText="Nombre" DataField="ctaContNom"     HeaderStyle-Width="150px" ItemStyle-Width="150px"  Display="true"  />
                                                <telerik:GridBoundColumn HeaderText="Abreviatura" DataField="ctaContAbr"     HeaderStyle-Width="100px"  ItemStyle-Width="100px"  Display="true"  />

                                                <telerik:GridBoundColumn HeaderText="salCGIni" DataField="salCCIni"     HeaderStyle-Width="208px"  ItemStyle-Width="100px"  Display="false"   />
                                                <telerik:GridBoundColumn HeaderText="salCGCgo" DataField="salCCCgo"     HeaderStyle-Width="208px"  ItemStyle-Width="100px"  Display="false"  />
                                                <telerik:GridBoundColumn HeaderText="salCGAbo" DataField="salCCAbo"     HeaderStyle-Width="208px"  ItemStyle-Width="100px"  Display="false"  />
                                                <telerik:GridBoundColumn HeaderText="Saldo"    DataField="saldo"    Aggregate="Sum"  FooterStyle-HorizontalAlign="Right"     HeaderStyle-Width="110px" ItemStyle-Width="110px"  Display="true" DataFormatString="{0:###,##0.00}" ItemStyle-HorizontalAlign="Right" />
