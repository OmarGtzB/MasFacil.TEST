...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMPForm" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        //GRET, se agrega Event Key Code 46 para borrar combo "Descuento" antes de calcular descuento
                        ...
                        <fieldset style=" margin-top:15px ">
                            ...
                            <table  style=" border-bottom-style:inset; border-bottom-width:1px; border-bottom-color:#355C82; width:1270px; text-align:left;  background-color:aliceblue;">
                                <tr  style="width:1270px;">                              
                                    ...
                                    <%-- Se agrega combo para seleccionar descuento --%>
                                      <td runat="server" visible="false" id="lblrcboDescuento" style=" width:80px; background-color:transparent; vertical-align:top;">
                                        <asp:Label ID="Label10" runat="server" Text="Descuento"></asp:Label>
                                    </td>
                                    <td runat="server" visible="false" id="tdrcboDescuento" style=" width:260px; background-color:transparent; vertical-align:top;">                                    
                                        <telerik:RadComboBox ID="rCboDescuento" runat="server" Enabled="true"   OnClientLoad="onClientLoad"
                                            OnSelectedIndexChanged="rCboDescuento_SelectedIndexChanged"
                                            Width="150px"                                           
                                            HighlightTemplatedItems="true"
                                            DropDownCssClass="cssRadComboBox"  
                                            DropDownWidth="300px" Height="200px" 
                                            AutoPostBack="True" >
                                            <HeaderTemplate>
                                                <table style="width: 250px" cellspacing="0" cellpadding="0">
                                                    <tr>
