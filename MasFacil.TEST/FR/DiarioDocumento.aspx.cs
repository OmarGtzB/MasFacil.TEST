...
public partial class FR_DiarioDocumento : System.Web.UI.Page
{
    #region VARIABLES
    ...
    protected void rBtnVizualizarDoc_Click(object sender, Telerik.Web.UI.ImageButtonClickEventArgs e)
    {
        MostraPdf();
    }
    ...
    {
        FNGrales.bTitleDesc(Page, "Diario de Documentos", "PnlMPFormTituloApartado");
    }
    ...
    private void MostraPdf()
    {
        ...
        ProcBD1.NombreProcedimiento = "sp_RptDataSetDoc_DiarioDocumento";
        ...
        { 
            ...
            DataTable ordersTable1 = customerOrders.Tables.Add("Table1");

            DataRow rowTmp1 = ordersTable1.NewRow();
            if (ordersTable.Columns.Count == 0)
            {
                ordersTable1.Clear();
                ordersTable1.Columns.Add("ciaImgLogo");
            }
            ...
            if (ordersTable.Columns.Count == 0)
            {
               ...
               // ordersTable.Columns.Add("ciaImgLogo");
                ...
                //rowTmp["ciaImgLogo"] =      ds.Tables[0].Rows[0]["ciaImgLogo"].ToString();

                 rowTmp1["ciaImgLogo"] = ds.Tables[0].Rows[0]["ciaImgLogo"].ToString();
            ...
            else
            {
                ...
                rowTmp["formImpRpt"] = "rptDiario";


            ordersTable.Rows.Add(rowTmp);
            ordersTable1.Rows.Add(rowTmp1);

            byte[] bytes = oWSRpt.byte_FormatoDoc(customerOrders, ds1);

            UrlPdf = "Diario" + "-" + DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Day.ToString() +
