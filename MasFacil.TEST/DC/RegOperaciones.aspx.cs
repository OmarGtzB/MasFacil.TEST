...
public partial class DC_RegOperaciones : System.Web.UI.Page
{
    ...
    //Se agrega evento para el combo Descripcion
    ...
    public void InicioPagina()
    {
        ...
        //Llena combobox Descripcion
        FnCtlsFillIn.RadComboBox_Descripcion(Pag_sConexionLog, Pag_sCompania, 50, rCboTipoConcepto.SelectedValue ,ref rCboDescripcion, true, false, "");
    ...
    private void EjecutaAccionLimpiar()
    {
		...
		//Se agregan el combo Concepto y Descripcion al metodo del boton limpiar 
    ...
    {
        //Se comenta if y else para que el grid muestre toda la informacion sin filtros
        ...
        //{
            ...
            //Se agrega if para filtrar por descripcion 
            if ( rCboDescripcion.SelectedIndex != -1)
            {
            ProcBD.AgregarParametrosProcedimiento("@transFolio", DbType.String, 200, ParameterDirection.Input, rCboDescripcion.SelectedValue);
            }
            //
    ...
    private void EnableFiltros()
    {
        ...
        if (rCboTipoConcepto.SelectedIndex == -1)
        {
            ...
            if (rCboConcepto.SelectedIndex == -1)
            {
                //Se habilitan en true los combos situacion, Fec.Ini., Fec.Fin. para que se muestren habilitados siempre
