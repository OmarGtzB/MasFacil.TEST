<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MttoInstitucionesDeposito.aspx.cs" Inherits="DC_MttoInstitucionesDeposito" %>
        ...
        <ContentTemplate>
            <div>
                ...
                <div style="width:100%; display:table; position:static; background-color:transparent;" align="center" >
                                ...
                                <table border="0" style=" width:780px; border-style:none;   text-align:left; background-color:transparent;">
                                    <tr>  
                                        <td style=" width:125px; background-color:transparent; ">
                                            Clave
                                        </td>
                                        <td style=" width:65px; background-color:transparent; ">
                                            <telerik:RadTextBox ID="rtxtClave" runat="server" Width="50px"
                                        ...
                                        <td style=" width:250px; background-color:transparent; ">
                                            <telerik:RadTextBox ID="rTxtDescripcion" runat="server" Width="230px"
                                                        EnabledStyle-CssClass="cssTxtEnabled" MaxLength="50"
                                                        DisabledStyle-CssClass ="cssTxtEnabled"
                                                        HoveredStyle-CssClass="cssTxtHovered"
                                                        FocusedStyle-CssClass="cssTxtFocused"
                                        ...
                                        <td style=" width:250px; background-color:transparent; ">
                                            <telerik:RadTextBox ID="rTxtRFC" runat="server" Width="200px"
                                                        EnabledStyle-CssClass="cssTxtEnabled" MaxLength="50"
                                                        DisabledStyle-CssClass ="cssTxtEnabled"
                                                        HoveredStyle-CssClass="cssTxtHovered"
                                                        FocusedStyle-CssClass="cssTxtFocused"
                                ...
                                <table border="0" style=" width:780px; border-style:none;   text-align:left; background-color:transparent;">
                                    <tr>  
                                        ...
                                        <td style=" width:680px; background-color:transparent; ">
                                            <telerik:RadTextBox ID="rTxtRazonSocial" runat="server" Width="645px"
                                                        EnabledStyle-CssClass="cssTxtEnabled" MaxLength="500"
                                                        DisabledStyle-CssClass ="cssTxtEnabled"
                                                        HoveredStyle-CssClass="cssTxtHovered"
                                                        FocusedStyle-CssClass="cssTxtFocused"
                                                        InvalidStyle-CssClass="cssTxtInvalid"  Enabled="false"                                   
                ...
                <div style="width:100%; display:table; margin-top:5px; position:static; background-color:transparent;" align="center">
                    ...
                    <telerik:RadGrid ID="rGdvDeposito"  OnSelectedIndexChanged="rGdvDeposito_SelectedIndexChanged"
                        runat="server"
                        ...
                        <MasterTableView DataKeyNames="insDepCve"  
                                         AutoGenerateColumns="False"  
                                          CssClass="GridTable" >

                         <Columns >
                             <telerik:GridBoundColumn DataField="insDepCve"    HeaderText="Clave"  HeaderStyle-Width="40px" ItemStyle-Width="40px" />
                             <telerik:GridBoundColumn DataField="insDepDes"    HeaderText="Descripción"  HeaderStyle-Width="75px"  ItemStyle-Width="75px" /> 
                             <telerik:GridBoundColumn DataField="insDepRFC"    HeaderText="RFC"  HeaderStyle-Width="75px"  ItemStyle-Width="75px" />    
                             <telerik:GridBoundColumn DataField="insDepRazSoc" HeaderText="Razón Social"  HeaderStyle-Width="200px"  ItemStyle-Width="200px" /> 
                        </Columns>
