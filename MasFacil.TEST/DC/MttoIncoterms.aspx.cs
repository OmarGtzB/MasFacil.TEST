...
public partial class DC_MttoIncoterms : System.Web.UI.Page
{
    #region VARIABLES
    ...
    protected void rGdvIconterms_SelectedIndexChanged(object sender, EventArgs e)
    {
        var dataItem = rGdvIconterms.SelectedItems[0] as GridDataItem;
        if (dataItem != null)
        {
            ...
            //{
                ...
                //}
                string skey = dataItem.GetDataKeyValue("incoCve").ToString();
                string val = dataItem["incoAbr"].Text;
                string val1 = dataItem["incoDes"].Text;
                ...
                {
                    rtxtClave.Text = dataItem["incoCve"].Text;
                }
                ...
                {
                    rTxtAbre.Text = dataItem["incoAbr"].Text;
                }
                ...
                {
                    rTxtDescripcion.Text = dataItem["incoDes"].Text;
                }
    ...
    private void InicioPagina()
    {
        ...
        hdfBtnAccion.Value = "";
        ControlesAccion();
        rGdvIconterms.ClientSettings.Selecting.AllowRowSelect = true;
        rGdvIconterms.AllowMultiRowSelection = true;
        PermisoBotones();
    }
    ...
    private void LlenaGrid()
    {
        ...
        ProcBD.NombreProcedimiento = "sp_Incoterms";
        ProcBD.AgregarParametrosProcedimiento("@opc", DbType.Int64, 0, ParameterDirection.Input, 50);
        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);


        ds = oWS.ObtenerDatasetDesdeProcedimiento(ProcBD.ObtenerXmlProcedimiento(), Pag_sConexionLog);
        FnCtlsFillIn.RadGrid(ref rGdvIconterms, ds);
    }
    ...
    private void EjecutaSpAccionEliminar()
    {
        try
        {
            ...
            foreach (GridDataItem i in rGdvIconterms.SelectedItems)
            {

                var dataItem = rGdvIconterms.SelectedItems[CountItems] as GridDataItem;
                if (dataItem != null)
                {

                    string incoCve = dataItem.GetDataKeyValue("incoCve").ToString();
                    try
                    {
                        ...
                        ProcBD.AgregarParametrosProcedimiento("@incoCve", DbType.String, 3, ParameterDirection.Input, incoCve);
                        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
    ...
    private void EjecutaSpAcciones()
    {
        ...
        ProcBD.AgregarParametrosProcedimiento("@opc", DbType.Int64, 0, ParameterDirection.Input, hdfBtnAccion.Value);
        ProcBD.AgregarParametrosProcedimiento("@ciaCve", DbType.String, 10, ParameterDirection.Input, Pag_sCompania);
        ProcBD.AgregarParametrosProcedimiento("@incoCve", DbType.String, 3, ParameterDirection.Input, rtxtClave.Text.Trim());
        ProcBD.AgregarParametrosProcedimiento("@incoDes", DbType.String, 50, ParameterDirection.Input, rTxtDescripcion.Text.Trim());
        ProcBD.AgregarParametrosProcedimiento("@incoAbr", DbType.String, 20, ParameterDirection.Input, rTxtAbre.Text.Trim());
    ...
    private string validaEjecutaAccion(ref string sMSGTip)
    {
        ...
        if (hdfBtnAccion.Value == Convert.ToUInt16(MGMValores.Constantes.btnAccion.Modificar).ToString())
        {
            ...
            if (rGdvIconterms.SelectedItems.Count == 0)
            {
    ...
    private void ControlesAccionEjecucion(bool Result)
    {
        if (Result == true)
        {
            ...
            if (hdfBtnAccion.Value == Convert.ToUInt16(MGMValores.Constantes.btnAccion.Nuevo).ToString())
            {
                ...
                rGdvIconterms.MasterTableView.ClearSelectedItems();
            ...
            if (hdfBtnAccion.Value == Convert.ToUInt16(MGMValores.Constantes.btnAccion.Modificar).ToString())
            {
                ...
                rGdvIconterms.AllowMultiRowSelection = false;
                this.rtxtClave.Enabled = false;
                this.rTxtAbre.Enabled = true;
                this.rTxtDescripcion.Enabled = true;
    ...
    {
        string sResult = "";
        int GvSelectItem = rGdvIconterms.SelectedItems.Count;
        string[] GvVAS;
        ...
        if (hdfBtnAccion.Value == Convert.ToUInt16(MGMValores.Constantes.btnAccion.Modificar).ToString())
        {
            ...
            if (FNValida.bAcciones_ValidacionesGVSelect(Pag_sConexionLog, rGdvIconterms, GvVAS, ref sMSGTip, ref sResult) == false)
            {
                return sResult;
            }
        }
