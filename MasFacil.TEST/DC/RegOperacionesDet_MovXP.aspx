<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegOperacionesDet_MovXP.aspx.cs" Inherits="DC_RegOperacionesDet_Mov" %>
                        ...
                        <div style="width:100%; display:table; position:static; background-color:transparent;" >
                            ...
                            <table border="0" style=" text-align:left; background-color:transparent; width:100%" >
                                <tr>
                                    ...
                                    <td>
                                         <telerik:RadLabel ID="RadLabel8" runat="server" Text="Cuenta" Width="125px" BackColor="transparent"></telerik:RadLabel>
