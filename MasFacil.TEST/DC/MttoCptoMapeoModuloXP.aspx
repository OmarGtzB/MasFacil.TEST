<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MttoCptoMapeoModuloXP.aspx.cs" Inherits="DC_MttoCptoMapeoModuloXP" %>
                            ...
                            <table border="0" style=" text-align:left; background-color:transparent; width:100%" >
                                <tr>
                                    <td>
                                        ...
                                        <asp:RadioButton ID="TipoCliente" runat="server" GroupName="TipoAplicacion" Text="Proveedor"   Enabled="false" BackColor="transparent" Width="100px" />
                                    </td>
                                    <td>
                                         <telerik:RadLabel ID="RadLabel8" runat="server" Text="Sec. de Codigo" Width="125px" BackColor="transparent"></telerik:RadLabel>
                    ...
                    <fieldset style="  margin-top:5px;   display: block; text-align:left;" >
                     ...
                     <div style="width:100%; display:table; margin-top:5px; position:static; background-color:transparent;" align="center">         
                          ...
                          <telerik:RadGrid ID="rGdv_MapeoModulo" 
                                ...
                                <MasterTableView DataKeyNames="movMapXPSecApli"  AutoGenerateColumns="false" CssClass="GridTable"    >
                                    <Columns> 
                        
                                        <telerik:GridBoundColumn HeaderText="Secuencia"  DataField="movMapXPSecApli"   HeaderStyle-Width="50px"  ItemStyle-Width="100px" ></telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn HeaderText="Movimiento"  DataField="movMapXPCoA"   HeaderStyle-Width="80px"  ItemStyle-Width="100px" ></telerik:GridBoundColumn>      
                                        <telerik:GridBoundColumn HeaderText="Tipo"  DataField="movMapXPTipApli"   HeaderStyle-Width="60px"  ItemStyle-Width="100px" ></telerik:GridBoundColumn>  
                                        <telerik:GridBoundColumn HeaderText="Sec. de Codigo"  DataField="cptoConfIdRef10"   HeaderStyle-Width="140px"  ItemStyle-Width="100px" ></telerik:GridBoundColumn>                                                      
                                    </Columns>
